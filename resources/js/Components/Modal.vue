        ...
        <div class="fixed inset-0 z-50 overflow-y-auto px-4 py-6 sm:px-0" scroll-region>
            <Transition enter-active-class="ease-out duration-300" enter-from-class="opacity-0"
                ...
                <div v-show="show" class="fixed inset-0 transform transition-all" @click="close">
                    <div class="absolute inset-0 opacity-75 bg-stone-900" />
                </div>
            </Transition>
            ...
            <Transition enter-active-class="ease-out duration-300"
                ...
                <div v-show="show"
                    class="mb-6 transform overflow-hidden rounded-lg shadow-xl transition-all sm:mx-auto sm:w-full bg-stone-800"
                    :class="maxWidthClass">
                    <slot v-if="showSlot" />
                </div>
            </Transition>
